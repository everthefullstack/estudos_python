...
def init_app(app: Flask):
    ...
    data_mapper = DataMapper(orm = app.config.ORM, model = model)
    ...
    bp.add_url_rule(rule="/get_usuario", view_func=controller.get, methods=["GET"])
    bp.add_url_rule(rule="/get_usuarios", view_func=controller.get_all, methods=["GET"])
